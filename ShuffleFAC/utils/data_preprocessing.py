"""Simple audio-folder dataset used by the original ShuffleFAC entry.

The adapted experiment script has its own cache builder; this helper is
kept for direct class-folder training.
"""
...
class dataset(Dataset):
    """Scan audio files and return log-mel tensors with class ids."""
    ...
    def get_label_from_path(self, file_path: Path) -> Optional[Tuple[str, int]]:
        # Labels are inferred from any path component matching a class name.
